...
${a12.message}`);
      ...
      let fo = process.env.CLERK_API_VERSION || "v1", fp = process.env.CLERK_SECRET_KEY || "", fq = process.env.CLERK_MACHINE_SECRET_KEY || "", fr = "pk_test_c2F2ZWQtamFndWFyLTg0LmNsZXJrLmFjY291bnRzLmRldiQ", fs = process.env.CLERK_ENCRYPTION_KEY || "", ft = process.env.CLERK_API_URL || ((a10) => {
