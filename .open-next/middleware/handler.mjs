...
var BuildId = "2xC2YL6UuckZAZw-ZNCQ-";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^\\/app(?:\\/(_next\\/data\\/[^/]{1,}))?\\/user(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/user/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "2xC2YL6UuckZAZw-ZNCQ-", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "RzuUQeUhHlHqrn2/pvq+X4PLyL+7w+7YHkEuW1Tu8Ds=", "__NEXT_PREVIEW_MODE_ID": "bdd556f29113ed0ef87987adb8aeb07d", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "ce299bc3969a12201ea5cfa84d5502584f6dbb228d00ac90fef0826d052343a3", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "48242598aa643f035b94de6cebe561099e2c15bde48c750ca965057b8b24379a" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/booking-settings/[id]/route": "/api/booking-settings/[id]", "/api/bookingdates/route": "/api/bookingdates", "/api/getUser/route": "/api/getUser", "/api/payGates/route": "/api/payGates", "/api/payGates/notify/route": "/api/payGates/notify", "/favicon.ico/route": "/favicon.ico", "/api/booking/route": "/api/booking", "/api/User/route": "/api/User", "/api/booking-settings/route": "/api/booking-settings", "/api/operating-hours/route": "/api/operating-hours", "/api/team/getActiveProvider/route": "/api/team/getActiveProvider", "/api/operating-hours/[id]/route": "/api/operating-hours/[id]", "/api/services/route": "/api/services", "/api/booking/[id]/route": "/api/booking/[id]", "/api/team/route": "/api/team", "/(public)/about/page": "/about", "/(public)/contact/page": "/contact", "/(public)/booking/page": "/booking", "/(public)/payment/cancel/page": "/payment/cancel", "/(public)/page": "/", "/(public)/payment/success/page": "/payment/success", "/(public)/user/page": "/user", "/admin/OperatingHours/page": "/admin/OperatingHours", "/(public)/client/page": "/client", "/admin/Reports/page": "/admin/Reports", "/admin/Services/page": "/admin/Services", "/admin/page": "/admin", "/admin/booking/[id]/page": "/admin/booking/[id]", "/admin/Team/page": "/admin/Team", "/admin/ContentManagement/page": "/admin/ContentManagement", "/(public)/user/[id]/page": "/user/[id]" };
