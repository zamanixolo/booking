...
var BuildId = "xhsJ50lyKWLBczXqNUBNC";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^\\/app(?:\\/(_next\\/data\\/[^/]{1,}))?\\/user(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/user/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "xhsJ50lyKWLBczXqNUBNC", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "RzuUQeUhHlHqrn2/pvq+X4PLyL+7w+7YHkEuW1Tu8Ds=", "__NEXT_PREVIEW_MODE_ID": "bdd556f29113ed0ef87987adb8aeb07d", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "ce299bc3969a12201ea5cfa84d5502584f6dbb228d00ac90fef0826d052343a3", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "48242598aa643f035b94de6cebe561099e2c15bde48c750ca965057b8b24379a" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/booking-settings/[id]/route": "/api/booking-settings/[id]", "/api/bookingdates/route": "/api/bookingdates", "/api/getUser/route": "/api/getUser", "/api/payGates/route": "/api/payGates", "/favicon.ico/route": "/favicon.ico", "/api/booking-settings/route": "/api/booking-settings", "/api/User/route": "/api/User", "/api/operating-hours/route": "/api/operating-hours", "/api/booking/[id]/route": "/api/booking/[id]", "/api/operating-hours/[id]/route": "/api/operating-hours/[id]", "/api/team/getActiveProvider/route": "/api/team/getActiveProvider", "/api/services/route": "/api/services", "/api/booking/route": "/api/booking", "/api/team/route": "/api/team", "/(public)/about/page": "/about", "/(public)/booking/page": "/booking", "/(public)/user/page": "/user", "/(public)/page": "/", "/admin/OperatingHours/page": "/admin/OperatingHours", "/admin/booking/[id]/page": "/admin/booking/[id]", "/admin/page": "/admin", "/admin/Reports/page": "/admin/Reports", "/admin/Services/page": "/admin/Services", "/admin/Team/page": "/admin/Team", "/admin/ContentManagement/page": "/admin/ContentManagement", "/(public)/client/page": "/client", "/(public)/contact/page": "/contact", "/(public)/user/[id]/page": "/user/[id]" };
